...
def add_context_layers_robust(fig, minx, miny, maxx, maxy, show_cuencas=True, show_muni=False):
    """Agrega capas vectoriales de contexto respetando los interruptores de la barra lateral."""
    try:
        if show_muni:
